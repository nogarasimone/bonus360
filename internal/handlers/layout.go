...
import "bonusperme/internal/config"
...
func SharedHeader(activePage string) string {
	homeActive, cafActive, contattiActive := "", "", ""
	switch activePage {
	case "/":
		homeActive = " active"
	case "/per-caf":
...
func SharedFooter() string {
	return `<footer class="site-footer" role="contentinfo"><div class="footer-inner">` +
		...
		`<p>Progetto gratuito e open source &middot; <a href="https://github.com/nicospa/bonusperme" style="color:var(--blue-mid)">GitHub</a></p>` +
		`</div></div></footer>`
}
